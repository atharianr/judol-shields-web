    ...
    return (
        <div className='bg-white border-[0.5px] border-gray-300 shadow-2xl rounded-3xl overflow-hidden'>
            <form onSubmit={onSubmit}>
                ...
                <button type='submit' className='flex py-3 px-8 my-3 mx-3 w-max bg-[#2F3396] text-white rounded-2xl hover:bg-[#2F3396]/80 duration-500 ml-auto cursor-pointer'>Submit now</button>
            </form>
        </div>
    )
}